...
from vqvae2d.helper import BasicBlocks
from vqvae2d.mednext import Encoder_MedNext
from vqvae2d.decoder import Decoder
from vqvae2d.codebook import Codebook
import os
...
class VQGAN(nn.Module):
    ...
    def forward(self, imgs, info=None, KD = False):
        ...
        decoded_images,proj_fea = self.decoder(x_lis)
        q_loss = loss[0] + loss[1] + loss[2] + loss[3]
        
        if KD == False:
            return decoded_images, codebook_indices, q_loss
        else:
            return decoded_images, codebook_indices, q_loss,encoded_images, proj_fea
